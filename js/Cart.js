...
function renderCart() {
    ...
    const totalDiscounted = cart.reduce((sum, item) => {
        var _a
        return sum + ((_a = item.discountPrice) !== null && _a !== void 0 ? _a : item.price)
    }, 0)
    ...
    document.querySelectorAll('.cart__item__remove').forEach((btn) => {
        btn.addEventListener('click', (e) => {
            ...
            if (target === null || target === void 0 ? void 0 : target.dataset.id) removeFromCart(target.dataset.id)
        })
    })
    updateCartCounter()
}
...
function renderAuthSection() {
    ...
    `
        ;(_a = document.getElementById('signInBtn')) === null || _a === void 0
            ? void 0
            : _a.addEventListener('click', () => {
                  window.location.href = 'login.html'
              })
        ;(_b = document.getElementById('registerBtn')) === null || _b === void 0
            ? void 0
