...
export function initI18n() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch('./translations/translations.json');
...
function translatePage() {
    ...
    const allElements = document.querySelectorAll('[data-i18n], [data-i18n-placeholder], [data-i18n-title], [data-i18n-alt], [data-i18n-aria]');
    // один цикл forEach вместо пяти
    allElements.forEach(el => {
        var _a;
        // ищем, какой именно атрибут data-i18n-* есть у элемента
        const attr = (_a = Array.from(el.attributes).find(a => a.name.startsWith('data-i18n'))) === null || _a === void 0 ? void 0 : _a.name;
        if (!attr)
            return;
